package io.hexlet.hexletcorrection.domain.validator;

import io.hexlet.hexletcorrection.domain.constrant.ValidPassword;
...
public class PasswordConstraintValidator implements ConstraintValidator<ValidPassword, String> {
    ...
    public boolean isValid(String password, ConstraintValidatorContext context) {
        final CharacterRule characterRule = new CharacterRule(EnglishCharacterData.UpperCase, 1);
